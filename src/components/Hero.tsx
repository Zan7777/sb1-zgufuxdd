...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16 sm:pt-20 pb-8 sm:pb-12 px-3 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-4 sm:gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-3 sm:space-y-6 lg:space-y-8 text-center lg:text-left">
            <div className="space-y-2 sm:space-y-4 lg:space-y-6">
              <div className="inline-flex items-center px-2 py-1 sm:px-3 sm:py-1.5 lg:px-4 lg:py-2 bg-gradient-to-r from-pink-500/10 to-red-500/10 rounded-full border border-pink-500/20 backdrop-blur-sm">
                <TrendingUp className="w-2.5 h-2.5 sm:w-3 sm:h-3 lg:w-4 lg:h-4 text-blue-600 mr-1 sm:mr-1.5 lg:mr-2" />
                <span style={{ fontSize: 'clamp(10px, 2.5vw, 14px)' }} className="text-blue-700 font-medium">Premium OnlyFans Management</span>
              </div>
              
              <h1 className="font-bold text-gray-900 leading-tight" style={{ fontSize: 'clamp(24px, 7vw, 40px)' }}>
                Transform Your
              ...
              <p className="text-gray-600 leading-relaxed max-w-2xl mx-auto lg:mx-0" style={{ fontSize: 'clamp(12px, 3.5vw, 18px)' }}>
              ...
              <button className="w-full sm:w-auto px-4 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-full hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-blue-500/25 min-h-[44px] text-sm sm:text-base">
                Start Your Transformation
              </button>

              {/* Secondary CTA */}
              <button className="w-full sm:w-auto px-4 sm:px-6 py-3 sm:py-4 bg-white/10 text-gray-900 border border-gray-200 rounded-full font-semibold hover:bg-gray-50 transition-all duration-300 backdrop-blur-sm min-h-[44px] text-sm sm:text-base">
                View Case Studies
              </button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-4 lg:gap-6 max-w-xs sm:max-w-md mx-auto lg:max-w-none mt-4 sm:mt-6">
                <div className="text-center">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-gradient-to-r from-blue-100 to-purple-100 rounded-lg sm:rounded-xl lg:rounded-2xl flex items-center justify-center mx-auto mb-1 sm:mb-2 lg:mb-3">
                    <TrendingUp className="w-3.5 h-3.5 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-blue-600" />
                  </div>
                  <div className="font-bold text-gray-900 mb-0.5 sm:mb-1 tabular-nums" style={{ fontSize: 'clamp(14px, 4vw, 24px)' }}>847%</div>
                  <div className="text-gray-600" style={{ fontSize: 'clamp(10px, 2.8vw, 14px)' }}>Growth Rate</div>
                </div>
                <div className="text-center">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-gradient-to-r from-blue-100 to-purple-100 rounded-lg sm:rounded-xl lg:rounded-2xl flex items-center justify-center mx-auto mb-1 sm:mb-2 lg:mb-3">
